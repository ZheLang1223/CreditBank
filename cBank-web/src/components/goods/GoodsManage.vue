<template>
    <div>
        <div style="margin-bottom: 5px;">
            ...
            <el-button type="primary" style="margin-left: 5px;" @click="add" v-if="user.roleId != 1">提交申请</el-button>
            <el-button type="primary" style="margin-left: 5px;" @click="inGoods" v-if="user.roleId !=2">通过</el-button>
            <el-button type="primary" style="margin-left: 5px;" @click="outGoods" v-if="user.roleId !=2">驳回</el-button>
        </div>
        ...
        >
            ...
            <el-table-column prop="storage" label="大类课程" width="180" :formatter="formatStorage">
            </el-table-column>
            <el-table-column prop="goodstype" label="细分课程" width="180" :formatter="formatGoodstype">
            </el-table-column>
            <el-table-column prop="credits" label="学分" width="180" :formatter="formatCredits">
            </el-table-column>
        ...
        <el-dialog
            ...
            <el-form ref="form" :rules="rules" :model="form" label-width="80px">
                ...
                <el-form-item label="大类课程" prop="storage">
                    <el-col :span="20">
                        <el-select v-model="form.storage" placeholder="请选择大类课程" style="margin-left: 5px;">
                            <el-option
                                    v-for="item in storageData"
                                    :key="item.id"
                                    :label="item.name"
                ...
                <el-form-item label="细分课程" prop="goodstype">
                    <el-col :span="20">
                        <el-select v-model="form.goodstype" placeholder="请选择细分课程" style="margin-left: 5px;">
                            <el-option
                                    v-for="item in goodstypeData"
                                    :key="item.id"
                                    :label="item.name"
...
<!--
            ...
            <el-form ref="form1" :rules="rules1" :model="form1" label-width="80px">
              ...
              <el-form-item label="状态">
                ...
                <el-input
                    v-model="form1.count"
                    :placeholder="form1.action === '1' ? '通过' : (form1.action === '2' ? '未通过' : '')"
                    disabled
                ></el-input>
              </el-form-item>
                <el-form-item label="备注" prop="remark">
        ...
        data() {
            ...
            return {
                ...
                rules: {
                    ...
                    storage:[
                        {required: true, message: '请选择大类课程', trigger: 'blur'}
                    ],
                    goodstype:[
                        {required: true, message: '请选择细分课程', trigger: 'blur'}
                    ],
                  count: [
                      {required: true, message: '请输入数量', trigger: 'blur'},
                      {pattern: /^([0-1])/,message: '数量必须为0或1',trigger: "blur"},
