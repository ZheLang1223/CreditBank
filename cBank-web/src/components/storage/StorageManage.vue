<template>
    <div>
        <div style="margin-bottom: 5px;">
            <el-input v-model="name" placeholder="请输入大类课程" suffix-icon="el-icon-search" style="width: 200px;"
        ...
        >
            ...
            <el-table-column prop="name" label="大类课程" width="180">
            </el-table-column>
        ...
        <el-dialog
            ...
            <el-form ref="form" :rules="rules" :model="form" label-width="80px">
                <el-form-item label="大类课程" prop="name">
                    <el-col :span="20">
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    name: [
                        {required: true, message: '请输入大类课程', trigger: 'blur'}
                    ]
                }
            }
        },
